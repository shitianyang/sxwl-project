package com.sxwl.monitor.service.impl;

import com.sxwl.monitor.model.VO.GcInfoVO;
...
public class JvmInfoServiceImpl implements JvmInfoService {
    ...
    private static final Logger log = LoggerFactory.getLogger(JvmInfoServiceImpl.class);
